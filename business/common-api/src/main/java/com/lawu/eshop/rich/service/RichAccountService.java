...
public interface RichAccountService {
    ...
    Result<PersonalRichAccountDTO> getPersonalRichAccountInfo(@RequestParam("userNum") String userNum,@RequestParam("userType")UserTypeEnum userType);

    @RequestMapping(method = RequestMethod.GET, value = "getRichInfo")
	Result<RichDetailDTO> getRichInfo(@RequestParam("userType")UserTypeEnum userType);
