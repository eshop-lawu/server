...
public interface ProductBrandService {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "productBrand/getProductBrandByName")
    Result<ProductBrandDTO> getProductBrandByName(@RequestParam("brandName") String brandName, @RequestParam("categoryId") Integer categoryId);
}
