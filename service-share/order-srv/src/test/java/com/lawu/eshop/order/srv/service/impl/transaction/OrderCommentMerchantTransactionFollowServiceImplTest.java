...
public class OrderCommentMerchantTransactionFollowServiceImplTest extends EmbeddedRedis {
    ...
    public void receiveNotice() {
    	...
    	orderCommentMerchantTransactionFollowServiceImpl.receiveNotice(notification, new Date().getTime());
