 ...
 */
public class ShoppingRefundAutoFirstTimeRemindToBeRefundWithReturnRefundJob extends AbstractTxPageJob<ShoppingOrderItemExtendDO> {
    ...
    public List<ShoppingOrderItemExtendDO> queryPage(int offset, int pageSize) {
        return shoppingRefundDetailService.selectAutoFirstTimeRemindToBeRefundWithReturnRefund(offset, pageSize);
    }
