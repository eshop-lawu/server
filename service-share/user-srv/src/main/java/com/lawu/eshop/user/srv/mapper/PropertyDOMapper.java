...
public interface PropertyDOMapper {
     ...
     * @mbg.generated
     */
    int countByExample(PropertyDOExample example);
     ...
     * @mbg.generated
     */
    List<PropertyDO> selectByExampleWithBLOBsWithRowbounds(PropertyDOExample example, RowBounds rowBounds);
     ...
     * @mbg.generated
     */
    List<PropertyDO> selectByExampleWithBLOBs(PropertyDOExample example);
     ...
     * @mbg.generated
     */
    int updateByExampleWithBLOBs(@Param("record") PropertyDO record, @Param("example") PropertyDOExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeyWithBLOBs(PropertyDO record);
